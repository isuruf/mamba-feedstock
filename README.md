...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/mamba-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mamba-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
Installing `libmamba` from the `conda-forge/label/mamba_prerelease` channel can be achieved by adding `conda-forge/label/mamba_prerelease` to your channels with:
...
Once the `conda-forge/label/mamba_prerelease` channel has been enabled, `libmamba, libmamba-spdlog, libmambapy, libmambapy-stubs, mamba` can be installed with `conda`:
